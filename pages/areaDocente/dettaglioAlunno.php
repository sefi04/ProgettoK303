...
<body class="bg-dark d-flex flex-column align-items-center p-3">
    ...
    <div class="container mt-4 d-flex flex-column align-items-center bg-primary rounded w-75 p-4 text-white">
        ...
        <h3>Data di Nascita: <?php echo $alunno['data_nascita'] ?></h3>
        ...
        <h3>Punteggio: <?php echo $alunno['punteggio'] ?></h3>
        <h3>Probabilità: <?php $prob=100-$alunno['punteggio']%100; echo $prob; ?>%</h3>
    ...
    <table class="table table-dark table-bordered table-striped w-75">
        ...
        <tbody>
            <?php
                ...
                $table=$conn->query("SELECT intervento.data, intervento.descrizione, intervento.punteggio,intervento.tipologia,intervento.cod_richiesta FROM intervento WHERE intervento.cod_alunno=$idAlunno;
                ");
